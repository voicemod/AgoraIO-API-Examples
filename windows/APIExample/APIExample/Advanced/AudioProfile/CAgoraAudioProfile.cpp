...
BEGIN_MESSAGE_MAP(CAgoraAudioProfile, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraAudioProfile::OnEIDConnectionStateChanged)
END_MESSAGE_MAP()
...
LRESULT CAgoraAudioProfile::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
