...
BEGIN_MESSAGE_MAP(CAgoraOriginalVideoDlg, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraOriginalVideoDlg::OnEIDConnectionStateChanged)
...
LRESULT CAgoraOriginalVideoDlg::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
