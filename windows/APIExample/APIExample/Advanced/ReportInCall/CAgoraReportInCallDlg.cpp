...
BEGIN_MESSAGE_MAP(CAgoraReportInCallDlg, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraReportInCallDlg::OnEIDConnectionStateChanged)
...
LRESULT CAgoraReportInCallDlg::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
