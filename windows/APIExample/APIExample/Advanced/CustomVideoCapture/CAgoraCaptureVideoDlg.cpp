...
BEGIN_MESSAGE_MAP(CAgoraCaptureVideoDlg, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraCaptureVideoDlg::OnEIDConnectionStateChanged)
...
LRESULT CAgoraCaptureVideoDlg::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
