...
BEGIN_MESSAGE_MAP(CAgoraCaptureAduioDlg, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraCaptureAduioDlg::OnEIDConnectionStateChanged)
...
LRESULT CAgoraCaptureAduioDlg::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
