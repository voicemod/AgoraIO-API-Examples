...
BEGIN_MESSAGE_MAP(CAgoraEffectDlg, CDialogEx)
	...
	ON_MESSAGE(WM_MSGID(EID_CONNECTION_STATE_CHANGED), &CAgoraEffectDlg::OnEIDConnectionStateChanged)
END_MESSAGE_MAP()
...
LRESULT CAgoraEffectDlg::OnEIDConnectionStateChanged(WPARAM wParam, LPARAM lParam)
{
